...
def main(args):
    ...
    for data in test_data_loader:
        ...
        result.save(f"./src/output_1000/{i}.jpg")
        i += 1
...
def parse_args():
    ...
    parser.add_argument("--test_LR_path", default='./src/datasets/Set5', type=str)
    parser.add_argument("--scale", type=int, default=4)
    parser.add_argument("--generator_path", type=str, default='./src/ckpt/G_model_1000.ckpt')
